...
public class ETQ {
    ...
    private final String FCHECK = "fcheck" ;
    ...
    public String getNextCheck() {
        return CHECK + (etiqs.get(CHECK) + 1) ;
    }

    public String getCheck() {
        etiqs.put(CHECK, etiqs.get(CHECK) + 1) ;
        return CHECK + etiqs.get(CHECK) ;
    }

    public String getNextFcheck() {
        return FCHECK + (etiqs.get(FCHECK) + 1) ;
    }

    public String getFcheck() {
        etiqs.put(FCHECK, etiqs.get(FCHECK) + 1) ;
        return FCHECK + etiqs.get(FCHECK) ;
    }
}
